...
export const Icons = {
  ...
  debian: (props: IconProps) => (
    <svg
      enableBackground="new 0 0 87.041 108.445"
      height="108.445"
      overflow="visible"
  ...
  ubuntu: (props: IconProps) => (
    ...
    >
      <title>Ubuntu</title>
      <circle cx="50" cy="50" fill="#f47421" r="45" />
      <circle
        cx="50"
        cy="50"
        fill="none"
      ...
      />
      <g id="ubuntu__a">
        <circle cx="19.4" cy="50" fill="#f47421" r="8.4" />
        <path d="M67 50h10" stroke="#f47421" strokeWidth="3.2" />
        <circle cx="19.4" cy="50" fill="#fff" r="6" />
      </g>
      <use transform="rotate(120 50 50)" xlinkHref="#ubuntu__a" />
      <use transform="rotate(240 50 50)" xlinkHref="#ubuntu__a" />
    </svg>
  ),
